# react-url-search-state-adapter-react-router-dom-v6

> [react-router-dom](https://github.com/remix-run/react-router) v6 adapter for [react-url-search-state](https://github.com/dennisduong/react-url-search-state).

## Install

```bash
npm install react-url-search-state@alpha react-url-search-state-adapter-react-router-dom-v6@alpha
```

**Peer dependency:** `react-router-dom@^6.30.1`
